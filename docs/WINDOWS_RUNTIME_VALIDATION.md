...
and that worker output does not contain the test username or password. The gate includes a UI Automation
audit for native controls and accessible names. It fails above the contract
limits of 300 ms warm launch, 100 ms first viewport, 100 ms address-navigation p95, or 50 ms
input p95. Results are written to
